(function() {
    ...
    u("WeakMap", function(a) {
        ...
        b.prototype.set = function(h, l) {
            ...
            f(h);
            if (!D(h, e)) throw Error("WeakMap key fail: " + h);
            h[e][this.g] = l;
            return this
        };
        b.prototype.get = function(h) {
            return d(h) && D(h, e) ? h[e][this.g] : void 0
        };
        b.prototype.has = function(h) {
            return d(h) && D(h, e) && D(h[e], this.g)
        };
        b.prototype.delete = function(h) {
            return d(h) && D(h, e) && D(h[e], this.g) ? delete h[e][this.g] : !1
        };
        return b
    });
    u("Map", function(a) {
    ...
    */
    ...
    var Ta, O;
    a: {
        for (var Ua = ["CLOSURE_FLAGS"], P = E, Va = 0; Va < Ua.length; Va++)
            if (P = P[Ua[Va]], P == null) {
                O = null;
                break a
            }
            ...
            a: if (Hb.has(d.origin)) {
                ...
                if (k && d.origin === k.O) switch (d = k.U, d.s = !0, d.s && (I(d.m, d.sendMessage, d), d.m.length = 0), k = f.event, f = f.info, k) {
                    ...
                    case "initialDelivery":
                        F(f) && (clearInterval(d.i), d.playerInfo = {}, d.v = {}, Kb(d, f.apiInterface), Jb(d, f));
                        break;
                    default:
                        d.j.i ||
                            (e = {
    ...
    function Ob(a, b) {
        ...
        Nb.yt_embedsEnableIframeApiSendFullEmbedUrl && (window.location.href && (e.forigin = window.location.href), (b = window.location.ancestorOrigins) && b.length > 0 && (e.aorigins = Array.from(b).join(",")), window.document.referrer && (e.gporigin = window.document.referrer));
